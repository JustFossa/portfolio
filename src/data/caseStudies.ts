...
export const caseStudies: CaseStudy[] = [
	{
		...
		results: [
			...
			},
			{
				value: "100/100",
				label: {
					cs: "SEO — připraveno, aby vás našli",
					en: "SEO — ready to be found",
				},
			},
		],
		...
		results: [
			{
				value: "94/100",
				label: {
					cs: "rychlost = méně odchodů z webu",
					en: "speed = fewer drop-offs",
				},
			},
			{
				value: "0.5s",
		...
		results: [
			{
				value: "20 000+",
				label: {
					cs: "zasažených čtenářů měsíčně",
					en: "readers reached every month",
				},
			},
		],
		link: "https://24newsro.ro",
		quote: {
